...
`FEATURE.md` fixes required outcomes and constraints. `IMPLEMENTATION.md` fixes
task outcomes, real dependencies, validation, and stop conditions—not the coding
path. Treat likely files, dependency-free ordering, and proposed techniques as
