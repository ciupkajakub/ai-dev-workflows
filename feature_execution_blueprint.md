...
12. `ai-workflow/AGENTS.md` is generated by this blueprint and is read by the workflow prompts. If a project wants agent-wide auto-loading outside this workflow, it can add its own root instruction file that points to `ai-workflow/AGENTS.md`, but that is optional and project-specific.
